...
. Connect your wallet. If you are using an escrow, connect the wallet associated with your escrow.  If you are a validator, connect with your validator wallet
.. if you are using SGX for validator wallet - please follow the instructions https://github.com/payvint/sgx-snapshot-vote/[here].
